            ...
            <div className="flex items-center gap-2">
              {isAuthenticated ? (
                <button
                  ...
                  className="flex items-center justify-center w-10 h-10 rounded-full bg-transparent text-[#6B7280] hover:text-[#9CA3AF] transition-colors"
                  title="Sign Out"
                >
                  <div className="h-6 w-6 i-ph:sign-out-thin" />
                </button>
              ) : (
                <button
                  ...
                  className="flex items-center justify-center w-10 h-10 rounded-full bg-transparent text-[#6B7280] hover:text-[#9CA3AF] transition-colors"
                >
                  <div className="h-6 w-6 i-ph:user-circle-thin" />
                </button>
              )}
